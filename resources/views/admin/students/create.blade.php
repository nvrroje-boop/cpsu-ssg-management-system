...
@section('page_title', 'Add Student or Officer')
@section('page_subtitle', 'Create a student or officer account with a valid department, year, and section assignment.')
...
@section('content')
    <div class="portal-form-shell">
        <x-card title="New Account" subtitle="Create a manageable portal account and send the initial credentials by email.">
            <form method="POST" action="{{ route('admin.students.store') }}" id="studentCreateForm" class="portal-form-stack">
                @csrf
                ...
                <div class="portal-form-grid">
                    <div class="field">
                        ...
                        <select id="role_id" name="role_id" required>
                            ...
                            @foreach ($roles as $role)
                                <option value="{{ $role['id'] }}" @selected((int) old('role_id') === $role['id'])>{{ $role['role_label'] }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="field">
                        ...
                        <input id="student_number" name="student_number" type="text" value="{{ old('student_number') }}" placeholder="Auto-generated when blank">
                ...
                <div class="portal-form-section">
                    <div class="portal-form-section__header">
                        <h2 class="portal-form-section__title">Academic Assignment</h2>
                        <p class="portal-form-section__text">Choose the department, year, and valid section combination for the account.</p>
                    </div>
                    ...
                    <div class="portal-form-grid">
                        <div class="field">
                            ...
                            <small class="portal-helper">Available departments: BEED, BSIT, BSAB.</small>
                        ...
                        <div class="field">
                            ...
                            <select id="year" name="year" required>
                                ...
                                <option value="1" @selected(old('year') === '1')>1</option>
                                <option value="2" @selected(old('year') === '2')>2</option>
                                <option value="3" @selected(old('year') === '3')>3</option>
                                <option value="4" @selected(old('year') === '4')>4</option>
                            </select>
                        ...
                        <div class="field">
                            ...
                            <small id="sectionHelp" class="portal-helper">Valid sections follow the selected year: 1=A-D, 2=A-C, 3=A, 4=A-D.</small>
                        ...
                        <div class="field">
                            ...
                            <div class="input-with-action">
                                <input id="password" name="password" type="text" value="{{ old('password') }}" readonly>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const previousSectionId = @json(old('section_id'));
