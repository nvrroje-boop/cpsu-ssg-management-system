...
Route::prefix('admin')
    ->name('admin.')
    ->middleware(['auth', 'password.changed', 'role:admin'])
    ->group(function (): void {
        ...
        Route::controller(StudentController::class)
            ...
            ->group(function (): void {
                ...
                Route::post('/{student}/resend-credentials', 'resendCredentials')->name('resend-credentials');
        ...
        Route::get('/analytics/attendance', [AttendanceAnalyticsController::class, 'index'])->name('attendance.analytics');
        Route::get('/analytics/attendance/{event}', [AttendanceAnalyticsController::class, 'event'])->name('attendance.event');
